...
VALUES -- example: (1,3,1,2019,5),
    ...
    (2, 1, 1, '2018', 9), -- 3 / 1,2,3,5
    (2, 2, 1, '2019', 8), -- 3 / 1,2,3,5
    (2, 3, 2, '2020', 7), -- 3 / 1,2,3,5
    (2, 5, 2, '2020', 8), -- 3 / 1,2,3,5
    ...
    (8, 1, 1, '2019', 0), -- 3 / 1,2,3,5
    (8, 2, 2, '2020', 6), -- 3 / 1,2,3,5
    (8, 3, 2, '2020', 7), -- 3 / 1,2,3,5
    (8, 5, 1, '2018', 0), -- 3 / 1,2,3,5
